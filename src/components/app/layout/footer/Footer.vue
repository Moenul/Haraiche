      ...
      <div class="md:flex md:flex-row md:justify-between">
        ...
        <div>
          ...
          <div class="logo flex items-center">
            <img class="w-20" src="/images/LogoSoft.png" alt="" />
            <h1 class="text-3xl font-bold font-mono">Haraiche</h1>
          </div>

          <p class="font-inter mt-4 max-w-80 text-base font-light text-gray-500">
        ...
        <div class="mt-10 flex flex-col md:mt-0">
          <!-- ITEM -->
          <div class="mb-4 flex flex-row items-center max-w-72">
            <svg
              width="40"
              height="40"
              viewBox="0 0 24 40"
            ...
            <p class="font-inter ml-4 text-black">8502 Preston Rd. Inglewood, Maine 98380, USA</p>
          </div>
          <!-- ITEM -->
          <div class="mb-4 flex flex-row items-center max-w-72">
            <svg
            ...
            <p class="font-inter ml-4 text-black">support@flowspark.co</p>
          </div>
        </div>
      </div>
      <!-- DIVIDER -->
      <div class="mx-auto my-12 w-full border border-gray-300 md:my-20"></div>
      <!-- COPYRIGHT TEXT -->
      <div>
        <p class="font-inter text-center text-sm text-gray-500 md:mt-0">
          © Copyright 2021. All rights reserved.
        </p>
        <p class="font-inter text-center text-sm text-gray-500 md:mt-0">
          Design & Development credit goes to
          <a href="https://www.linkedin.com/in/moenul/">Moenul Islam</a>.
        </p>
      </div>
    </div>
  </footer>
